...
const int bishop_pair[2] = {13,26}; /// 0 = midgame, 1 = endgame;
const int passed_pawn[2][8] = {
{ 0, 7, 16, 17, 64, 170, 278, 319},
{ 0, 27, 32, 40, 71, 174, 262, 304}	
}; /// [1][8] = midgame, [2][8] = endgame;
const int isolated_pawn[2] = {-3, -15}; /// 0 = midgame, 1 = endgame;
const int r_evalfile[2] = {19,47}; /// 0 = semiopen, 1 = open
